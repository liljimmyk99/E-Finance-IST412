...
public class OtherAppViewController extends AnchorPane implements Initializable {
    ...
    public void createApplication(String name, String address, String phoneNumber, String ssn, double yearlyIncome, Integer creditScore, String underGradDegree, boolean currentlyEmployed, boolean married){
        loanApplication = new OtherApplication(name, address, phoneNumber, ssn, yearlyIncome, creditScore, underGradDegree,currentlyEmployed, married);
    }
    
    public void createApplication(){
        loanApplication = new OtherApplication();
    }
